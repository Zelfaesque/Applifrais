...
/**
 * Forfait2Controller implements the CRUD actions for Lignefraisforfait model.
 */
class Forfait2Controller extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    $userid = Yii::$app->user->id;
        ...
        $searchModel = new Lignefraisforfait2Search();
